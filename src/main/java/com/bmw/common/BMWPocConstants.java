...
public class BMWPocConstants {
	...
	public static final String CONTRACT_STATUS__ORDERED = "O";
	public static final String CONTRACT_STATUS__CREATED = "C";
	public static final String CONTRACT_STATUS__INVOICED = "I";
}
